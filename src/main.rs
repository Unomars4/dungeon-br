...
impl State {
    fn new() -> Self {
        ...
        let mut mb: MapBuilder = MapBuilder::new(&mut rng);
    ...
    fn game_over(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(1, RED, BLACK, "Your quest has ended.");
    ...
    fn victory(&mut self, ctx: &mut BTerm) {
        ...
        ctx.print_color_centered(
            ...
            WHITE,
            BLACK,
            "You put on the Amulet of Yala and feel its power course throught your veins.",
        );
        ctx.print_color_centered(
            5,
            WHITE,
    ...
    fn advance_level(&mut self) {
        ...
        <&mut FieldOfView>::query()
            ...
            .for_each(|fov| fov.is_dirty = false);
